    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-surface-card rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <h2 className="text-xl font-semibold text-content-primary">Delete Post</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-content-secondary text-sm leading-relaxed">
              ...
              <span className="text-content-primary font-medium">"{post?.title}"</span>?
            </p>
            <p className="text-content-faint text-xs mt-2">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-3 bg-surface-button hover:bg-surface-button-hover text-content-primary rounded-xl text-sm font-medium transition-colors"
            >
              Cancel
            </button>
            <button
