...
import { ClipboardList, Menu, X, ChevronRight } from "lucide-react"
...
const SidebarMenu = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className={`fixed left-0 top-0 h-full w-80 bg-[#111111] shadow-xl z-50 transition-transform duration-500 ease-in-out ${
