...
function StaffPlanningModal({ staffMembers, onClose }) {
  ...
  const renderAllShiftsCalendar = () => {
    ...
    return (
      <>
        <div className="bg-[#141414] rounded-xl p-4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
            <h3 className="text-lg font-semibold text-center sm:text-left">All Staff Schedule</h3>
        ...
        <div className="mt-4 bg-[#141414] rounded-xl p-4">
          <h3 className="text-lg font-semibold mb-2">Day Details</h3>
          {selectedDate ? (
            dayEntries.length > 0 ? (
              ...
              <p className="text-gray-400 text-sm">No shifts for {selectedDate.toLocaleDateString()}.</p>
            )
          ) : (
            <p className="text-gray-400 text-sm">Select a date to see who is scheduled.</p>
          )}
        </div>
      </>
    )
  ...
  return (
    <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center p-2 sm:p-4">
      <div className="bg-[#181818] text-white rounded-xl p-3 sm:p-4 md:p-6 w-full max-w-7xl custom-scrollbar max-h-[95vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
