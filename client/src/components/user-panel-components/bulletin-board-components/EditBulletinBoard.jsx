...
const OptimizedEditBulletinModal = memo(function OptimizedEditBulletinModal({
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .bulletin-edit-editor .ql-snow .ql-picker-item:hover { color: #2563eb !important; }
      .bulletin-edit-editor .ql-snow button:hover .ql-stroke { stroke: #2563eb !important; }
      .bulletin-edit-editor .ql-snow button:hover .ql-fill { fill: #2563eb !important; }
      .bulletin-edit-editor .ql-snow button.ql-active .ql-stroke { stroke: #2563eb !important; }
      .bulletin-edit-editor .ql-snow button.ql-active .ql-fill { fill: #2563eb !important; }
    `
