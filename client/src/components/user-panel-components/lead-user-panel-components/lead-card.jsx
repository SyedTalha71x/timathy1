...
const LeadCard = ({
  ...
  const handleDragStop = (e, data) => {
    setIsDragging(false)
    // <CHANGE> Pass the draggable node to calculate drop position for intra-column reordering
    onDragStop(e, data, lead, columnId, index, nodeRef.current)
  }
            ...
            {hasValidNote && (
              <div
                className={`absolute -top-2 -left-2 ${lead.specialNote.isImportant ? "bg-red-500 " : "bg-blue-500 "
                  } rounded-full p-0.5 shadow-[0_0_0_1.5px_white] z-10 cursor-pointer no-drag transition-all duration-200 hover:scale-110`}
