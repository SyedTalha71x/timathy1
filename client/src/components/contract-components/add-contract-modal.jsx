...
export function AddContractModal({ onClose, onSave, leadData = null }) {
  ...
  useEffect(() => {
    const contractType = contractTypes.find(
      (type) => type.name === contractData.rateType
    );
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center z-[1001]">
          <div className="bg-[#181818] p-6 rounded-2xl max-w-md w-full">
            ...
            <p className="text-gray-300 mb-6">
              How would you like to generate this contract?
            </p>
      ...
      {showPrintPrompt && (
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center z-[1001]">
          <div className="bg-[#181818] p-6 rounded-2xl max-w-md w-full">
            ...
            <p className="text-gray-300 mb-6">
              Would you like to print this contract?
            </p>
            <div className="flex flex-col gap-3">
              <button
                  ...
                  <div className="bg-[#101010]/60 p-4 rounded-xl border border-gray-800">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-white">
                          {selectedContractType.billingPeriod}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              {isDigital ? (
                <div>
                  {currentPage === 0 ? (
                    <div className="bg-white rounded-lg p-6 relative font-sans">
                      ...
                      <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-700 mb-2">
                          I have chosen the following plan:
                        </p>
                        ...
                        <div className="mt-4 text-sm text-gray-700">
                          <p>
                            The provider's terms and conditions apply, namely:
                          </p>
                          <p className="mt-2">
                            After the minimum term expires, the membership will
                            continue indefinitely at a price of €42.90/week,
                            unless terminated in writing within the notice
                            period of 1 month before the end of the minimum term
                            & no individual conditions for the subsequent period
                            are agreed in the "Contract remarks" text field.
                          </p>
                        </div>
                      </div>
                              ...
                              <input
                                ...
                                value={
                                  discount.isPermanent
                                    ? "Till End of Contract"
                                    : `${discount.duration} Billing Periods`
                                }
                                readOnly
                                className="w-full border border-gray-300 rounded p-2 text-black bg-gray-50"
                              />
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              <p className="text-xs text-gray-600 mb-1">
                                This contract is valid without signature
                              </p>
                    ...
                    <div className="bg-white rounded-lg p-6 relative font-sans">
                      <h1 className="text-black text-xl font-bold mb-4 text-[#8B4513]">
                      ...
                      <p className="text-sm text-gray-700 mb-4">
                        ...
                        <span className="font-medium">
                          payments from my account with creditor ID no:
                        </span>{" "}
                      ...
                      <p className="text-sm text-gray-700 mb-4">
                        ...
                        <span className="font-medium">
                          honor the direct debits drawn on my account.
                        </span>
                      </p>
                      ...
                      <div className="mb-6">
                        <div className="flex items-start mb-4">
                          ...
                          >
                            ...
                            <br />I hereby agree to the attached service
                            description & general terms and conditions (GTC),
                            unless otherwise agreed in writing in the "Contract
                            remarks" text field.
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="mb-6">
                        <div className="flex items-start mb-4">
                          ...
                          >
                            ...
                            <br />I hereby consent to the collection and
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-400">
                                {(contractData.signedFile.size / 1024).toFixed(
                                  2
                                )}{" "}
                                KB • Uploaded just now
                              </p>
                            </div>
                          </div>
                        </div>
