...
export const PermissionModal = ({ visible, onClose, role, onPermissionChange }) => {
    ...
    // Translation map for menu group labels
    const groupLabels = {
      "Members": t("admin.customers.permissionModal.members"),
      "Staff": t("admin.customers.permissionModal.staff"),
      "Leads": t("admin.customers.permissionModal.leads"),
      "Contracts": t("admin.customers.permissionModal.contracts"),
      "Finances": t("admin.customers.permissionModal.finances"),
      "Appointments": t("admin.customers.permissionModal.appointments"),
      "Training": t("admin.customers.permissionModal.training"),
      "Analytics": t("admin.customers.permissionModal.analytics"),
      "Communication": t("admin.customers.permissionModal.communication"),
      "Configuration": t("admin.customers.permissionModal.configuration"),
      "Notes": t("admin.customers.permissionModal.notes"),
      "To-Do & Tags": t("admin.customers.permissionModal.todoTags"),
      "Selling & Products": t("admin.customers.permissionModal.sellingProducts"),
      "Activity Monitor": t("admin.customers.permissionModal.activityMonitor"),
    };
    const tGroup = (g) => groupLabels[g] || g;
            ...
            <div className="bg-[#1C1C1C] rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-700">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold text-white">{t("admin.customers.permissionModal.title")}</h2>
