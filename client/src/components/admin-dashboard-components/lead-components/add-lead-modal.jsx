    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl text-white font-bold">{t("admin.leads.createLead")}</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm text-gray-200 block mb-2">
                      {t("admin.leads.form.fields.studioName")}<span className="text-red-500 ml-1">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">
                      {formData.studioName || (formData.firstName || formData.lastName 
                        ...
                        : <span className="text-gray-500 italic">{t("admin.leads.form.notes.newLead")}</span>)}
                    </p>
                    {formData.studioName && (formData.firstName || formData.lastName) && (
