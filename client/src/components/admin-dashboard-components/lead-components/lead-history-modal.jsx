      ...
      <div className="bg-[#181818] rounded-xl text-white p-4 md:p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">
            History - {lead.studioName || `${lead.firstName} ${lead.surname}`}
          </h2>
          {lead.studioName && (
            <p className="text-gray-400 text-sm mt-0.5">{lead.firstName} {lead.surname}</p>
          )}
        ...
        <div className="bg-[#141414] rounded-xl p-4">
          ...
          {activeTab === "trial" && (
            <div>
              <h3 className="text-lg font-semibold mb-4">Demo Access History</h3>
              <div className="space-y-3">
                {demoAccessHistory.map((activity) => (
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-gray-300">
                          Type: {activity.demoType} â€¢ Demo Date: {activity.demoDate} at {activity.demoTime}
                        </p>
                      </div>
                      <span
