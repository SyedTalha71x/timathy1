...
export default function BroadcastModal({
  ...
  const [activeMainTab, setActiveMainTab] = useState(emailOnly ? "email" : "push")
  const [audienceTab, setAudienceTab] = useState("studio")
  ...
  const [folderModalType, setFolderModalType] = useState("push")
  ...
  // Force active tab to 'email' when emailOnly is true
  useEffect(() => {
    if (emailOnly && activeMainTab !== "email") {
      setActiveMainTab("email")
    }
  }, [emailOnly, activeMainTab])

  // Folder management
  const handleOpenFolderModal = (folder = null, type = "push") => {
  ...
  const handleDeleteFolder = (folder, type = "push") => {
    setItemToDelete(folder)
    setDeleteType(type === "push" ? "pushFolder" : "emailFolder")
  ...
  // Message management - handles both push and email templates
    ...
    if (activeMainTab === "push") {
      ...
      if (editingMessage) {
        ...
        const updatedTemplate = {
          ...editingMessage,
          ...messageData,
          subject: messageData.title || editingMessage.subject,
          body: messageData.message || editingMessage.body
        }
        ...
        if (selectedEmailTemplate?.id === editingMessage.id) {
          setSelectedEmailTemplate(updatedTemplate)
        }
  ...
  const handleBroadcastClick = () => {
    ...
    // Construct settings to reflect chosen channel
    const sendSettings = {
      ...settings,
  ...
  return (
    <>
        ...
        <div className="bg-[#181818] rounded-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
          <div className="p-4">
            ...
            <div className="flex gap-1 mb-6 border-b border-gray-700">
              ...
              <button
                onClick={() => {
                  if (!emailOnly) setActiveMainTab("email")
                }}
                className={`px-4 py-2 text-sm rounded-t-lg ${
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                {/* Recipients dropdown trigger */}
                <button
                  onClick={() => {
                    setShowRecipientDropdown(!showRecipientDropdown)
                    if (!showRecipientDropdown) setSearchMember("")
                  }}
                  className="w-full py-3 bg-blue-600 text-sm hover:bg-blue-700 text-white rounded-xl mb-2"
                >
                  Select Recipients
                </button>
                    ...
                    <div className="p-2 border-b border-gray-800">
                      <div className="relative mb-2">
                        <input
                          ...
                          placeholder={`Search ${audienceTab}...`}
                          autoFocus
                        />
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleOpenFolderModal(null, "push")}
                  ...
                  <div className="relative">
                    ...
                    {selectedPushFolder && (
                      <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
                        <button
                          onClick={() => handleOpenFolderModal(selectedPushFolder, "push")}
                        ...
                        <button
                          onClick={() => handleDeleteFolder(selectedPushFolder, "push")}
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleOpenFolderModal(null, "email")}
                      className="text-blue-500 hover:text-blue-400 text-sm flex items-center gap-1"
                    >
                      <FolderPlus className="w-4 h-4" />
                      New Folder
                  ...
                  <div className="relative">
                    ...
                    {selectedEmailFolder && (
                      <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
                        <button
                          onClick={() => handleOpenFolderModal(selectedEmailFolder, "email")}
                          className="p-1 text-blue-500 hover:text-blue-400"
                          aria-label="Edit folder"
                        >
                          <Edit className="w-4 h-4" />
                        ...
                        <button
                          onClick={() => handleDeleteFolder(selectedEmailFolder, "email")}
                          className="p-1 text-red-500 hover:text-red-400"
                          aria-label="Delete folder"
                        >
                          <Trash2 className="w-4 h-4" />
            ...
            <div className="mt-5">
              <button
                ...
                className={`w-full py-3 flex items-center gap-2 justify-center ${
                  ...
                  (
                    (!emailOnly && activeMainTab === "push" && selectedPushMessage) ||
      ...
      {/* Email Template Modal - Now opens as proper modal window */}
      <MessageModal
