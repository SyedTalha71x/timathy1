...
const ContractDetailsModal = ({ isOpen, onClose, contract, onPause, onCancel }) => {
        ...
        {showContractImage ? (
          <div className="space-y-4 custom-scrollbar overflow-y-auto max-h-[70vh]">
            ...
            <div className="bg-white rounded-lg overflow-hidden">
              {/* Display contract image/document here */}
              <div className="w-full h-64 bg-gray-200 flex items-center justify-center">
                <p className="text-gray-500">Contract Document Preview</p>
              </div>
            </div>
