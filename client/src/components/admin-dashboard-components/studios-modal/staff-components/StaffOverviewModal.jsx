...
const StudioStaffModal = ({
  ...
  const handleUpdateContingent = (staffId, contingent, notes) => {
    // Update the staff's vacation days in your state
    // This is where you would update your backend as well
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-400 mt-1">
                      ...
                      {/* Display current vacation days if available */}
                      {staff.vacationDays !== undefined && (
                        <p className="text-orange-400">
                          Vacation Days: {staff.vacationDays}
                        </p>
                      )}
                    </div>
                  </div>
