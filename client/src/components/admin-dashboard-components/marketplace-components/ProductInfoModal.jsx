      ...
      <div className="bg-[#1C1C1C] rounded-lg w-full max-w-md mx-auto">
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-sm mb-3">Status: <span className={productForInfo?.isActive ? 'text-green-400' : 'text-red-400'}>{productForInfo?.isActive ? 'Active' : 'Inactive'}</span></p>
