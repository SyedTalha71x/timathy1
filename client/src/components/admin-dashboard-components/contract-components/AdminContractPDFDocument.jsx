...
/**
 * AdminContractPDFDocument - Generates exact PDF replica of admin/studio contract forms
 * Uses @react-pdf/renderer for high-quality client-side PDF generation
 * Admin Panel version: Uses studio/customer variable mappings instead of member mappings
 * 
...
// =============================================================================
// Admin Panel: Studio/Customer variable mappings
...
// =============================================================================
const AdminContractPDFDocument = ({ contractForm, formValues, systemValues }) => {
  ...
  return (
    <Document
      title={`Studio Contract - ${formValues?.studioName || ''}`}
      author="Admin Contract Management"
      subject="Studio License Agreement"
...
export default AdminContractPDFDocument;
