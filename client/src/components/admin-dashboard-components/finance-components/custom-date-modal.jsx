      ...
      <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
        <div className="bg-[#1C1C1C] rounded-xl w-full max-w-md p-4 md:p-6">
          <div className="flex justify-between items-center mb-3 md:mb-4">
            <h2 className="text-white text-base md:text-lg font-medium">{t("admin.finances.customDate.title")}</h2>
          ...
          <div className="space-y-3 md:space-y-4">
            <div>
              <label className="block text-gray-400 text-xs md:text-sm mb-2">{t("admin.finances.period.startDate")}</label>
              <input
                type="date"
                value={startDate}
            ...
            <div>
              <label className="block text-gray-400 text-xs md:text-sm mb-2">{t("admin.finances.period.endDate")}</label>
              <input
                type="date"
                value={endDate}
