      ...
      <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
        <div className="bg-[#1C1C1C] rounded-xl w-full max-w-md max-h-[80vh] overflow-hidden flex flex-col">
          <div className="p-3 md:p-4 border-b border-gray-800 flex justify-between items-center">
            <h2 className="text-white text-base md:text-lg font-medium">{t("admin.finances.servicesBreakdown.title")}</h2>
          ...
          <div className="p-3 md:p-4 overflow-y-auto flex-grow">
            <div className="mb-3 md:mb-4">
              ...
              <p className="text-gray-400 text-xs md:text-sm">{t("admin.finances.servicesBreakdown.studioDescription")}</p>
            </div>
            ...
            <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-gray-800">
              <div className="flex justify-between items-center">
                <span className="text-white font-semibold text-sm md:text-base">{t("admin.finances.servicesBreakdown.totalAmount")}</span>
