    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[60] p-4">
      <div className="bg-surface-base rounded-xl p-6 w-full max-w-md border border-border">
        ...
        <div className="space-y-3">
          <button
            onClick={onConfirm}
            className="w-full py-3 text-sm bg-primary hover:bg-primary-hover text-white rounded-xl active:scale-95 transition-transform flex items-center justify-center gap-2 font-medium"
          >
            <Plus size={16} />
            Yes, Create Contract
          </button>
