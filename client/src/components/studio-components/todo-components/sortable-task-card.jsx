      ...
      <div className="flex items-start gap-2">
        ...
        {isCanceled ? (
          <button
            ...
            className="mt-1 w-5 h-5 flex items-center justify-center text-content-muted bg-surface-button rounded-full cursor-pointer border border-border flex-shrink-0 active:scale-90"
          ...
          <div className="relative flex-shrink-0 mt-1">
            ...
            {isCheckboxAnimating && (
              <div className="absolute inset-0 flex items-center justify-center">
                <Check size={12} className="text-primary animate-tick" />
              </div>
            )}
          </div>
        )}
        ...
        <div className="flex-1 min-w-0">
          ...
          {isEditingTitle ? (
            <textarea
              ...
              className="w-full bg-surface-dark text-content-primary px-3 py-1.5 rounded-lg outline-none text-sm border-2 border-primary resize-none"
              ...
              {task.tags && task.tags.length > 0 && (
                <>
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap md:hidden">
                    ...
                    {task.tags.length > 2 && (
                      <span className="text-xs text-content-muted cursor-pointer" onClick={handleTagsClick}>
                        +{task.tags.length - 2}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="hidden md:flex items-center gap-1.5 flex-wrap">
                    ...
                    {task.tags.length > 5 && (
                      <span className="text-xs text-content-muted cursor-pointer hover:scale-105 transition-transform" onClick={handleTagsClick}>
                        +{task.tags.length - 5}
                      </span>
                    )}
                  </div>
        ...
        <div className="relative flex-shrink-0" ref={dropdownRef}>
          <button
            ...
            className="text-content-muted hover:text-primary p-2 -mr-1 rounded-xl hover:bg-surface-hover transition-colors active:scale-90"
          >
