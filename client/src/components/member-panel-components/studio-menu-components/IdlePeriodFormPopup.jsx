...
const IdlePeriodFormPopup = ({ show, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-3 sm:p-4 z-50">
      <div className="bg-surface-card rounded-xl p-4 sm:p-5 md:p-6 max-w-md w-full max-h-[85vh] sm:max-h-[80vh] overflow-y-auto border border-border shadow-2xl">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <button className="w-full bg-primary hover:bg-primary-hover text-white py-2.5 sm:py-3 px-4 rounded-lg transition-colors text-sm sm:text-base">
