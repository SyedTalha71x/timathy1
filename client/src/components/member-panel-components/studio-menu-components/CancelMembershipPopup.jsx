    ...
    <div className="absolute inset-0 bg-black/50 flex items-center justify-center p-3 sm:p-4 z-50">
      <div className="bg-surface-card rounded-xl p-4 sm:p-5 md:p-6 max-w-md w-full max-h-[85dvh] sm:max-h-[80dvh] overflow-y-auto border border-border shadow-2xl">
        <div className="flex justify-between items-center mb-3 sm:mb-4">
          <h3 className="text-lg sm:text-xl font-bold text-content-primary">{t("studioMenu.contract.cancelMembership")}</h3>
        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="bg-red-900/20 border border-red-800/30 rounded-lg p-3 sm:p-4">
            <h4 className="text-red-400 font-semibold mb-2 text-sm sm:text-base">{t("studioMenu.popup.cancellationInfo")}</h4>
            <p className="text-content-secondary text-xs sm:text-sm mb-2"><strong className="text-content-primary">{t("studioMenu.contract.noticePeriod")}:</strong> 1 month</p>
            <p className="text-content-secondary text-xs sm:text-sm mb-2"><strong className="text-content-primary">{t("studioMenu.contract.lastCancellation")}:</strong> December 15, 2025</p>
            <p className="text-content-secondary text-xs sm:text-sm"><strong className="text-content-primary">{t("studioMenu.popup.cancellationEffective")}:</strong> January 15, 2026</p>
          </div>

          <p className="text-content-secondary text-xs sm:text-sm">
            {t("studioMenu.popup.cancellationDesc")}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            >
              {t("studioMenu.popup.keepMembership")}
            </button>
            <button
            ...
            >
              {t("studioMenu.popup.confirmCancellation")}
            </button>
          </div>
        </div>
      </div>
