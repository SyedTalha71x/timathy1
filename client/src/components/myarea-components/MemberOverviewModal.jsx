...
export function MemberOverviewModal({
  isOpen,
  onClose,
  selectedMember,
  calculateAge,
        ...
        <div className="p-6">
          <div className="flex flex-col gap-4 bg-[#161616] rounded-xl p-4 md:p-6 mb-6 relative">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              ...
              <button
                className="text-gray-200 gap-2 cursor-pointer bg-black rounded-xl border border-slate-600 py-2 px-3 hover:text-white hover:border-slate-400 transition-colors text-sm flex items-center justify-center gap-"
                onClick={handleViewDetailedInfo}
              >
                <Eye size={16} /> View Details
              </button>
              <button
                className="text-gray-200 cursor-pointer bg-black rounded-xl border border-slate-600 py-2 px-3 hover:text-white hover:border-slate-400 transition-colors text-sm flex items-center justify-center gap-"
