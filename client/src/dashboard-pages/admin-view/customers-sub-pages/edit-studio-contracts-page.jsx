 ...
 *
 * Renders the shared ContractList page in "admin" mode,
 * passing the studioId so it loads studio-specific contract data.
 */
    ...
    <div className="flex flex-col h-full min-h-screen text-white">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-[#333333] flex-shrink-0">
        ...
        <span className="text-gray-300 text-sm font-medium">
          {studioName} — Contracts
        </span>
      </div>

      {/* Shared ContractList page in admin mode */}
