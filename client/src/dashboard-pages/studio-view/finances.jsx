        ...
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          ...
          <div className="flex items-center gap-2">
            <div className="relative" ref={periodDropdownRef}>
              <button onClick={() => setPeriodDropdownOpen(!periodDropdownOpen)} className="bg-surface-card text-content-primary px-3 sm:px-4 py-2 rounded-xl border border-border hover:border-primary flex items-center gap-2 text-xs sm:text-sm transition-colors">
            ...
            <table className="text-sm text-left text-content-secondary border-collapse w-full">
              ...
              <tbody>
                {sortedTransactions.map((transaction, index) => (
                  <tr key={transaction.id} className={`border-b border-border/50 hover:bg-surface-hover transition-colors ${index === sortedTransactions.length - 1 ? "rounded-b-xl" : ""}`}>
