            ...
            <div>
              ...
              <div className="space-y-4">
                {appointments.map((appointment, index) => (
                  <div
                    key={index}
                    className={`${appointment.color} p-3 md:p-4 open_sans_font rounded-xl flex items-center justify-between relative`}
                  >
                    ...
                    <div className="relative" ref={dropdownRef}>
                      ...
                      {openDropdownIndex === index && (
                        <div className="absolute right-5 top-3 mt-2 w-32 bg-[#2F2F2F]/10 backdrop-blur-xl rounded-xl  z-10">
                          <ul className="py-1">
                            <li>
                              <button
