          ...
          <div className="w-full md:w-2/3">
            ...
            {selectedStaff ? (
              ...
              <p className="text-sm md:text-base">
                Select a staff member to view and edit their schedule.
              </p>
            )}
          </div>
        </div>
      ...
      <div className="bg-[#181818] rounded-xl text-white p-4 md:p-6 w-full max-w-md">
        ...
        <div className="space-y-4">
          <select
            ...
            onChange={(e) =>
              setSelectedStaff(
                staffMembers.find((s) => s.id === parseInt(e.target.value))
              )
            }
        ...
        <button
          onClick={onClose}
          className="mt-2 bg-gray-500 text-white px-4 py-2 rounded-xl text-sm  w-full"
        >
          Close
        </button>
      </div>
