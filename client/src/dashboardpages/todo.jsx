  ...
  return (
    <>
      <div className="flex rounded-3xl  bg-[#1C1C1C] text-white relative min-h-screen overflow-hidden">
          ...
          <div className="lg:pb-36 md:pb-32 sm:pb-16 pb-16">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => setIsNotificationOpen(true)} className="lg:hidden text-gray-400 hover:text-white">
                  <Bell size={20} />
                </button>
              </div>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                      <div className="w-full flex justify-between items-center relative">
                        ...
                        <div className="relative">
                          <button className="text-gray-400 hover:text-white sm:hidden dropdown-trigger" onClick={(e) => toggleDropdown(task.id, e)}>
        ...
        <div className={`fixed lg:static inset-y-0 right-0 w-[320px] bg-[#181818] p-6 transform transition-transform duration-500 ease-in-out ${
          ...
          <div className="space-y-3">
            {notifications.map((notification) => (
              <div key={notification.id} className={`${getNotificationStyles(notification.type)} rounded-xl p-4 relative`}>
                <button onClick={() => removeNotification(notification.id)} className="absolute top-4 right-4 text-gray-400 hover:text-white">
                  <X size={16} />
                </button>
