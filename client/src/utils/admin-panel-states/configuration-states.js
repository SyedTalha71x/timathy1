...
// Default Contract Forms (Admin - simplified structure for template management)
export const DEFAULT_CONTRACT_FORMS = [
  {
    ...
    globalHeader: {
      enabled: true,
      content: "{Studio_Name} • Membership Contract • Member ID: {Member ID}",
      fontSize: 10,
      alignment: "center",
    ...
    folders: [
      { id: 1, name: "Personal Data", color: "#3B82F6", expanded: true, sortIndex: 0 },
      { id: 2, name: "Contract Details", color: "#F59E0B", expanded: true, sortIndex: 1 },
      { id: 3, name: "Payment Info", color: "#8B5CF6", expanded: true, sortIndex: 2 },
    ],
    pages: [
      {
        id: 1,
        title: "Personal Data & Contract",
  ...
  },
  {
    ...
    globalHeader: {
      enabled: true,
      content: "{Studio_Name} • Premium Contract",
      fontSize: 10,
      alignment: "center",
      verticalAlignment: "center",
      bold: true,
    ...
    folders: [
      { id: 1, name: "Member Info", color: "#10B981", expanded: true, sortIndex: 0 },
      { id: 2, name: "Terms", color: "#EF4444", expanded: true, sortIndex: 1 },
    ],
    pages: [
      {
        id: 1,
        ...
        elements: [
          ...
          },
          {
            ...
            width: 642,
            height: 45,
            content: "PREMIUM MEMBERSHIP AGREEMENT",
            fontSize: 26,
            fontFamily: "Arial, sans-serif",
            bold: true,
            italic: false,
          ...
          },
          {
            ...
            width: 582,
            height: 200,
            content: "<h3>Terms & Conditions</h3><p>By signing this agreement, the member confirms acceptance of all terms and conditions associated with the Premium membership, including the cancellation policy and payment obligations.</p><p>This contract is subject to the general terms of the studio.</p>",
            fontSize: 11,
            visible: true,
            sortIndex: 7,
            folderId: 2,
