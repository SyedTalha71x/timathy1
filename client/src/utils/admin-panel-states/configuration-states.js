...
// Default Contract Forms (Admin - using AdminContractFormFillModal variable mappings)
export const DEFAULT_CONTRACT_FORMS = [
  {
    ...
    globalHeader: {
      enabled: true,
      content: "{Studio_Name} • Service Agreement",
      fontSize: 10,
      alignment: "center",
    ...
    globalFooter: {
      enabled: true,
      content: "Page {page} of {pages} • {Studio_Name} • {Studio_Address}",
      fontSize: 9,
      alignment: "center",
      verticalAlignment: "center",
      bold: false,
    ...
    folders: [
      { id: 1, name: "Studio Owner", color: "#3B82F6", expanded: true, sortIndex: 0 },
      { id: 2, name: "Contract Details", color: "#F59E0B", expanded: true, sortIndex: 1 },
    ],
    pages: [
      {
        id: 1,
        ...
        elements: [
          {
            id: 1,
            type: 'heading',
            x: 0, y: 30, width: 642, height: 45,
            content: 'SERVICE AGREEMENT',
            fontSize: 28, fontFamily: 'Arial, sans-serif',
            bold: true, italic: false, underline: false,
            alignment: 'center', color: '#1F2937',
            visible: true, sortIndex: 0
          },
          {
            id: 2,
            type: 'divider',
            x: 100, y: 80, width: 442, height: 3,
            lineColor: '#FF843E', lineStyle: 'solid',
            visible: true, sortIndex: 1
          },
          {
            id: 3,
            type: 'subheading',
            x: 0, y: 100, width: 642, height: 30,
            content: '1. Studio Owner Information',
            fontSize: 16, fontFamily: 'Arial, sans-serif',
            bold: true, italic: false, underline: false,
            alignment: 'left', color: '#374151',
            visible: true, sortIndex: 2, folderId: 1
          },
          {
            id: 4,
            type: 'text',
            x: 0, y: 140, width: 300, height: 55,
            variable: 'Owner Name',
            label: 'Owner Name',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: true, visible: true, sortIndex: 3, folderId: 1
          },
          {
            id: 5,
            type: 'text',
            x: 320, y: 140, width: 300, height: 55,
            variable: 'Studio Name',
            label: 'Studio Name',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: true, visible: true, sortIndex: 4, folderId: 1
          },
          {
            id: 6,
            type: 'text',
            x: 0, y: 210, width: 300, height: 55,
            ...
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: true, visible: true, sortIndex: 5, folderId: 1
          },
          {
            id: 7,
            type: 'text',
            x: 320, y: 210, width: 300, height: 55,
            ...
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 6, folderId: 1
          },
          {
            id: 8,
            type: 'subheading',
            x: 0, y: 290, width: 642, height: 30,
            content: '2. Contract Details',
            fontSize: 16, fontFamily: 'Arial, sans-serif',
            bold: true, italic: false, underline: false,
            alignment: 'left', color: '#374151',
            visible: true, sortIndex: 7, folderId: 2
          },
          {
            id: 9,
            type: 'system-text',
            x: 0, y: 330, width: 300, height: 55,
            variable: 'Contract Type', label: 'Contract Type',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 8, folderId: 2
          },
          {
            id: 10,
            type: 'system-text',
            x: 320, y: 330, width: 300, height: 55,
            variable: 'Contract Cost', label: 'Monthly Cost',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 9, folderId: 2
          },
          {
            id: 11,
            type: 'system-text',
            x: 0, y: 400, width: 300, height: 55,
            variable: 'Contract Start Date', label: 'Start Date',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 10, folderId: 2
          },
          {
            id: 12,
            type: 'system-text',
            x: 320, y: 400, width: 300, height: 55,
            variable: 'Contract End Date', label: 'End Date',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 11, folderId: 2
          },
          {
            id: 13,
            type: 'signature',
            x: 0, y: 600, width: 300, height: 120,
            showLocationDate: true, location: '', showDate: true, dateFormat: 'de-DE',
            locationFontFamily: 'Arial, sans-serif', signatureFontSize: 12,
            locationBold: false, locationColor: '#374151',
            showBelowSignature: true, belowSignatureText: 'Studio Owner Signature',
            belowTextFontFamily: 'Arial, sans-serif', belowTextFontSize: 10,
            belowTextBold: false, belowTextColor: '#6B7280',
            visible: true, sortIndex: 12
          },
          {
            id: 14,
            type: 'signature',
            x: 340, y: 600, width: 300, height: 120,
            showLocationDate: true, location: '', showDate: true, dateFormat: 'de-DE',
            locationFontFamily: 'Arial, sans-serif', signatureFontSize: 12,
            locationBold: false, locationColor: '#374151',
            showBelowSignature: true, belowSignatureText: 'Platform Representative',
            belowTextFontFamily: 'Arial, sans-serif', belowTextFontSize: 10,
            belowTextBold: false, belowTextColor: '#6B7280',
            visible: true, sortIndex: 13
          },
        ],
      },
    ],
  ...
  {
    id: 2,
    name: "Premium Platform Agreement",
    globalHeader: {
      enabled: true,
      content: "{Studio_Name} • Premium Agreement",
      fontSize: 10, alignment: "center", verticalAlignment: "center",
      bold: true, italic: false, showOnPages: "all",
    },
    globalFooter: {
      enabled: true,
      content: "Page {page} of {pages} • Confidential",
      fontSize: 9, alignment: "center", verticalAlignment: "center",
      bold: false, italic: true, showOnPages: "all",
    },
    folders: [
      { id: 1, name: "Studio Owner", color: "#10B981", expanded: true, sortIndex: 0 },
      { id: 2, name: "Contract Info", color: "#F59E0B", expanded: true, sortIndex: 1 },
      { id: 3, name: "Terms", color: "#EF4444", expanded: true, sortIndex: 2 },
    ],
    pages: [
      {
        id: 1,
        ...
        elements: [
          {
            id: 1,
            type: 'image',
            x: 220, y: 10, width: 200, height: 80,
            src: null, visible: true, sortIndex: 0
          },
          {
            id: 2,
            type: 'heading',
            x: 0, y: 100, width: 642, height: 45,
            content: 'PREMIUM PLATFORM AGREEMENT',
          ...
          },
          {
            id: 3,
            type: 'divider',
            x: 80, y: 150, width: 482, height: 3,
            lineColor: '#F59E0B', lineStyle: 'solid',
            visible: true, sortIndex: 2
          },
          {
            id: 4,
            type: 'subheading',
            x: 0, y: 170, width: 642, height: 30,
            content: '1. Studio Owner',
            fontSize: 16, fontFamily: 'Arial, sans-serif',
            bold: true, italic: false, underline: false,
            alignment: 'left', color: '#374151',
            visible: true, sortIndex: 3, folderId: 1
          },
          {
            id: 5,
            type: 'text',
            x: 0, y: 210, width: 300, height: 55,
            variable: 'Owner Name', label: 'Owner Name',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
          ...
          },
          {
            ...
            type: 'text',
            x: 320, y: 210, width: 300, height: 55,
            variable: 'Studio Name', label: 'Studio',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
          ...
          },
          {
            id: 7,
            type: 'text',
            x: 0, y: 280, width: 300, height: 55,
            variable: 'Email Address', label: 'Email',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: true, visible: true, sortIndex: 6, folderId: 1
          },
          {
            id: 8,
            type: 'text',
            x: 320, y: 280, width: 300, height: 55,
            variable: 'Telephone Number', label: 'Phone',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
            inputBold: false, inputColor: '#1F2937',
            required: false, visible: true, sortIndex: 7, folderId: 1
          },
          {
            id: 9,
            type: 'subheading',
            x: 0, y: 360, width: 642, height: 30,
            content: '2. Contract Details',
            fontSize: 16, fontFamily: 'Arial, sans-serif',
            bold: true, italic: false, underline: false,
            alignment: 'left', color: '#374151',
            visible: true, sortIndex: 8, folderId: 2
          },
          {
            id: 10,
            type: 'system-text',
            x: 0, y: 400, width: 200, height: 55,
            variable: 'Contract Type', label: 'Plan',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
          ...
          },
          {
            id: 11,
            type: 'system-text',
            x: 220, y: 400, width: 200, height: 55,
            variable: 'Contract Cost', label: 'Cost',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
          ...
          },
          {
            id: 12,
            type: 'system-text',
            x: 440, y: 400, width: 200, height: 55,
            variable: 'Minimum Term', label: 'Min. Term',
            showTitle: true,
            labelFontSize: 12, labelFontFamily: 'Arial, sans-serif',
            labelBold: true, labelItalic: false, labelUnderline: false, labelColor: '#374151',
            inputFontSize: 14, inputFontFamily: 'Arial, sans-serif',
          ...
          },
          {
            id: 13,
            type: 'textarea',
            x: 0, y: 480, width: 642, height: 80,
            content: 'By signing this agreement, the studio owner confirms acceptance of all terms and conditions associated with the Premium platform subscription, including the cancellation policy and payment obligations.',
            fontSize: 11, fontFamily: 'Arial, sans-serif',
            italic: true, color: '#6B7280',
            alignment: 'left', lineHeight: 1.4,
            visible: true, sortIndex: 12, folderId: 3
          },
          {
            id: 14,
            type: 'signature',
            x: 0, y: 620, width: 300, height: 120,
            showLocationDate: true, location: '', showDate: true, dateFormat: 'de-DE',
            locationFontFamily: 'Arial, sans-serif', signatureFontSize: 12,
            locationBold: false, locationColor: '#374151',
            showBelowSignature: true, belowSignatureText: 'Studio Owner Signature',
          ...
          },
          {
            id: 15,
            type: 'signature',
            x: 340, y: 620, width: 300, height: 120,
            showLocationDate: true, location: '', showDate: true, dateFormat: 'de-DE',
            locationFontFamily: 'Arial, sans-serif', signatureFontSize: 12,
            locationBold: false, locationColor: '#374151',
            showBelowSignature: true, belowSignatureText: 'Platform Representative',
...
// Default Contract Types (Admin - without userCapacity/contingent, with accessTemplateId)
