...
// =============================================================================
// TRIAL TRAINING CONSTANTS
// =============================================================================
// Trial Training is a SEPARATE concept from regular appointment types.
// It always has its own fixed color (blue) regardless of the trialType selected.
// The trialType field stores which training type the trial is for (e.g., "EMS Strength")
// but the appointment color remains Trial Training blue.
export const TRIAL_TRAINING_COLOR = "bg-[#3B82F6]";
export const TRIAL_TRAINING_COLOR_HEX = "#3B82F6";
export const TRIAL_TRAINING_TYPE_ID = 5;
export const TRIAL_TRAINING_TYPE_NAME = "Trial Training";
...
const generateAppointmentsData = () => [
  ...
  { id: 13, title: "Trial Training", name: "Sarah", lastName: "Wilson", date: formatDisplayDate(-5), time: "17:00 - 18:00", startTime: "17:00", endTime: "18:00", status: "completed", type: "Trial Training", trialType: "EMS Cardio", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h2", staffId: 5, specialNote: { text: "Good session. Needs nutrition consultation first.", isImportant: false }, isTrial: true, isCancelled: false, isPast: true, isCheckedIn: true },
  ...
  { id: 11, title: "Trial Training", name: "John", lastName: "Smith", date: formatDisplayDate(-4), time: "10:00 - 11:00", startTime: "10:00", endTime: "11:00", status: "completed", type: "Trial Training", trialType: "EMS Strength", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h1", staffId: 5, specialNote: { text: "Converted to member! Very motivated.", isImportant: true }, isTrial: true, isCancelled: false, isPast: true, isCheckedIn: true },
  ...
  { id: 18, title: "Trial Training", name: "Emma", lastName: "Davis", date: formatDisplayDate(-3), time: "15:00 - 16:00", startTime: "15:00", endTime: "16:00", status: "cancelled", type: "Trial Training", trialType: "EMS Strength", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h4", staffId: 5, specialNote: { text: "Cancelled - price concerns. Follow up in 3 months.", isImportant: true }, isTrial: true, isCancelled: true, isPast: true, isCheckedIn: false },
  ...
  { id: 22, title: "Trial Training", name: "Justin", lastName: "Test", date: formatDisplayDate(-2), time: "14:00 - 15:00", startTime: "14:00", endTime: "15:00", status: "completed", type: "Trial Training", trialType: "Body Check", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h5", staffId: 5, specialNote: { text: "No-show. Tried calling, no answer.", isImportant: true }, isTrial: true, isCancelled: false, isPast: true, isCheckedIn: false },
  ...
  { id: 44, title: "Trial Training", name: "Emma", lastName: "Davis", date: formatDisplayDate(1), time: "15:00 - 16:00", startTime: "15:00", endTime: "16:00", status: "scheduled", type: "Trial Training", trialType: "EMS Cardio", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h4", staffId: 5, specialNote: { text: "Rescheduled - offered 20% discount.", isImportant: false }, isTrial: true, isCancelled: false, isPast: false, isCheckedIn: false },
  ...
  { id: 81, title: "Trial Training", name: "Sarah", lastName: "Wilson", date: formatDisplayDate(5), time: "14:00 - 15:00", startTime: "14:00", endTime: "15:00", status: "scheduled", type: "Trial Training", trialType: "EMP Chair", typeId: 5, color: "bg-[#3B82F6]", colorHex: "#3B82F6", memberId: null, leadId: "h2", staffId: 5, specialNote: { text: "Interested in group fitness and nutrition guidance.", isImportant: false }, isTrial: true, isCancelled: false, isPast: false, isCheckedIn: false },
];
...
// Check if an appointment is a Trial Training (separate from regular appointments)
export const isTrialTraining = (appointment) => {
  return appointment?.isTrial === true || appointment?.type === TRIAL_TRAINING_TYPE_NAME;
};

// Get the correct color for an appointment
// Trial Trainings ALWAYS use the Trial Training blue color, regardless of trialType
export const getAppointmentColor = (appointment) => {
  // Trial Trainings always have the same blue color
  if (isTrialTraining(appointment)) {
    return TRIAL_TRAINING_COLOR;
  }
...
// Get the correct hex color for an appointment
// Trial Trainings ALWAYS use the Trial Training blue color, regardless of trialType
export const getAppointmentColorHex = (appointment) => {
  // Trial Trainings always have the same blue color
  if (isTrialTraining(appointment)) {
    return TRIAL_TRAINING_COLOR_HEX;
  }
...
export const transformAppointmentFromBackend = (backendAppt) => ({
  ...
  trialType: backendAppt.trial_type || backendAppt.trialType,
  ...
  leadId: backendAppt.lead_id || backendAppt.leadId,
...
export default {
  // Trial Training Constants
  TRIAL_TRAINING_COLOR,
  TRIAL_TRAINING_COLOR_HEX,
  TRIAL_TRAINING_TYPE_ID,
  TRIAL_TRAINING_TYPE_NAME,
  // Appointment Types
