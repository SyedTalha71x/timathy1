...
const generateAppointmentsData = () => [
  ...
  { id: 106, title: "EMS Strength", name: "Robert", lastName: "Miller", date: formatDisplayDate(-1), time: "12:00 - 12:30", startTime: "12:00", endTime: "12:30", status: "cancelled", type: "EMS Strength", typeId: 1, color: "bg-[#EF4444]", colorHex: "#EF4444", memberId: 7, staffId: 2, specialNote: { text: "Cancelled - personal reasons", isImportant: false }, isTrial: false, isCancelled: true, isPast: true, isCheckedIn: false },
  { id: 107, title: "EMS Cardio", name: "Lisa", lastName: "Garcia", date: formatDisplayDate(-1), time: "16:00 - 16:30", startTime: "16:00", endTime: "16:30", status: "cancelled", type: "EMS Cardio", typeId: 2, color: "bg-[#10B981]", colorHex: "#10B981", memberId: 8, staffId: 3, specialNote: { text: "Cancelled - work conflict", isImportant: false }, isTrial: false, isCancelled: true, isPast: true, isCheckedIn: false },
  ...
  { id: 108, title: "EMS Strength", name: "Thomas", lastName: "Anderson", date: formatDisplayDate(0), time: "12:00 - 12:30", startTime: "12:00", endTime: "12:30", status: "cancelled", type: "EMS Strength", typeId: 1, color: "bg-[#EF4444]", colorHex: "#EF4444", memberId: 9, staffId: 2, specialNote: { text: "Cancelled - sick", isImportant: false }, isTrial: false, isCancelled: true, isPast: false, isCheckedIn: false },
  { id: 109, title: "Body Check", name: "Jennifer", lastName: "Martinez", date: formatDisplayDate(0), time: "13:00 - 13:30", startTime: "13:00", endTime: "13:30", status: "cancelled", type: "Body Check", typeId: 4, color: "bg-[#06B6D4]", colorHex: "#06B6D4", memberId: 10, staffId: 4, specialNote: { text: "Cancelled - rescheduled to next week", isImportant: false }, isTrial: false, isCancelled: true, isPast: false, isCheckedIn: false },
  ...
  { id: 110, title: "EMS Cardio", name: "John", lastName: "Doe", date: formatDisplayDate(1), time: "12:30 - 13:00", startTime: "12:30", endTime: "13:00", status: "cancelled", type: "EMS Cardio", typeId: 2, color: "bg-[#10B981]", colorHex: "#10B981", memberId: 1, staffId: 3, specialNote: { text: "Cancelled - vacation", isImportant: false }, isTrial: false, isCancelled: true, isPast: false, isCheckedIn: false },
...
export const availableMembersLeadsMain = membersData.map(m => ({ 
  id: m.id, 
  ...
  type: "member", 
  image: m.image,
  // Include note fields for special note icon
  note: m.note || "",
  noteImportance: m.noteImportance || "unimportant",
  noteStartDate: m.noteStartDate || "",
  noteEndDate: m.noteEndDate || "",
  noteStatus: m.noteStatus || "general",
  notes: m.notes || [],
}));
