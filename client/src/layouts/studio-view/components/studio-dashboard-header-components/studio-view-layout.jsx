        ...
        paddingTop: "calc(env(safe-area-inset-top, 0px) + 3.5rem)",
          ...
          {taskToDelete && (
            <div className="fixed inset-0 text-content-primary bg-black/50 flex items-center justify-center z-50">
              <div className="bg-surface-card rounded-xl p-6 max-w-md mx-4">
                <h3 className="text-lg font-semibold mb-4">{t("studio.layout.deleteTask")}</h3>
                <p className="text-content-secondary mb-6">{t("studio.layout.deleteTaskConfirm")}</p>
          ...
          {taskToCancel && (
            <div className="fixed inset-0 bg-black/50 text-content-primary flex items-center justify-center z-50">
              <div className="bg-surface-card rounded-xl p-6 max-w-md mx-4">
                <h3 className="text-lg font-semibold mb-4">{t("studio.layout.cancelTask")}</h3>
                <p className="text-content-secondary mb-6">{t("studio.layout.cancelTaskConfirm")}</p>
                <div className="flex gap-3 justify-end">
                  <button 
